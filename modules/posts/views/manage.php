...
<?php
flashdata();
echo '<p>'.anchor('posts/create', 'Create New Post Record', array("class" => "button"));
if(strtolower(ENV) === 'dev') {
    echo anchor('api/explorer/posts', 'API Explorer', array("class" => "button alt"));
}
echo '</p>';
    ...
    <table id="results-tbl">
        <thead>
            <tr>
                <th colspan="3">
                    <div>
                        <div><?php
                        echo form_open('posts/manage/1/', array("method" => "get"));
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= anchor('posts/show/'.$row->id, 'View', $attr) ?></td>        
            </tr>
            <?php
            }
            ?>
