...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('posts/manage', 'View All Posts', array("class" => "button alt"));
        echo anchor('posts/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
        ...
        <div class="card-body">
            <div class="record-details">
                <div class="row">
                    ...
                    <div><?= $primary_object ?></div>
                </div>
                <div class="row">
                    <div>Secondary Object</div>
                    <div><?= $secondary_object ?></div>
                </div>
                <div class="row">
                    <div class="full-width">
                        <div><b>Tutorial</b></div>
                        <div><?= nl2br($tutorial) ?></div>
                    </div>
                </div>
                <div class="row">
                    <div class="full-width">
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('posts/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a post record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
